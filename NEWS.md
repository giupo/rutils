...
* Pkg: usr: evaluate prev_quarter based on day of the year. [Giuseppe Acito]
...
* Added .Rprofile for packrat; moved from 'Depends:' to 'Imports:' in DESCRIPTION. [Giuseppe Acito]

* Moved Depends to Imports to less cluttering in namespace. [Giuseppe Acito]
...
* Adds is.Stack to NAMESPACE; adds show method to Stack. [Giuseppe Acito]
...
* Passo a R6 e JunitReporter trovato su https://github.com/lbartnik/testthat/blob/junit-xml2/R/reporter-junit.R. [Giuseppe Acito]
...
* Aggiunge .randomString e .containsString al NAMESPACE. [Giuseppe Acito]
